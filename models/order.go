...
type Order struct {
	...
	OrderDe     string    `orm:"column(order_de);size(10);null" description:"주문일"`
	...
	TotalAmt    int       `orm:"column(total_amt);null" description:"주문총액"`
	DiscountAmt int       `orm:"column(discount_amt);null" description:"할인액"`
	PayAmt      int       `orm:"column(pay_amt)" description:"결제액"`
